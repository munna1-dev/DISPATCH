...
app.put(
  ...
  async (req, res) => {
    ...
    const currentLocation = cleanString(
      b.current_location,
      300
    );
    ...
    /*
     * Event timestamps are generated by the server.
     * This prevents an administrator's browser from
     * inserting arbitrary historical/future timestamps.
     */
    const c = await pool.connect();
